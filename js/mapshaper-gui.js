(function () {
    ...
    var utils$1 = /*#__PURE__*/Object.freeze({
        ...
        get getKeyComparator() {
            return getKeyComparator;
        },
        get getGenericComparator() {
            return getGenericComparator;
        },
        get quicksort() {
            return quicksort;
        },
        ...
        get findRankByValue() {
            return findRankByValue;
        },
        get findValueByPct() {
            return findValueByPct;
        },
        get findValueByRank() {
            return findValueByRank;
        },
        get findMedian() {
            return findMedian;
        },
        ...
        get findStringPrefix() {
            return findStringPrefix;
        },
        get isFiniteNumber() {
            return isFiniteNumber;
        },
        get isNonNegNumber() {
            return isNonNegNumber;
        },
        get parsePercent() {
            return parsePercent;
        },
        get formatVersionedName() {
            return formatVersionedName;
        },
        get uniqifyNames() {
            return uniqifyNames;
        },
        get cleanNumericString() {
    ...
    /**
     * FORESTAR: isReadableFileType（是否可读文件类型）
     * @param filename
     * @returns {boolean|*}
     */
    ...
    /**
     * FORESTAR: parseFreeformOptions（解析自由表单配置）
     * @param raw
     * @param cmd
     * @returns {*}
     */
    ...
    function ImportControl(gui, opts) {
        ...
        /**
         * FORESTAR: findMatchingShp（找到匹配的Shp文件）
         * @param filename
         * @returns {*[]}
         */
        ...
        /**
         * FORESTAR: addFilesToQueue（上传文件入队列）
         * @param files
         */
        ...
        /**
         * FORESTAR: showQueuedFiles（展示队列文件）
         */
        ...
        /**
         * FORESTAR: receiveFilesQuickView（通过快捷视图接收文件）
         * @param files
         */
        ...
        /**
         * FORESTAR: procNextQueuedFile（处理下一个队列文件）
         */
        ...
        /**
         * FORESTAR: isShapefilePart（是否含有shapfile的相关文件组成部分）
         * @param name
         * @returns {boolean}
         */
        // TODO: support .cpg
        ...
        /**
         * FORESTAR: importFileContent（读取导入文件配置）
         * @returns {{}}
         */
        ...
        /**
         *  FORESTAR: readImportOptsAsString（读取导入配置作为字符串返回）
         */
        // for CLI output
        ...
        /**
         * FORESTAR: handleZipFiles（处理压缩文件）
         * @param files
         * @returns {*}
         */
  ...
  */
    ...
    */
    ...
    function GuiInstance(container, opts) {
        ...
        /**
         * FORESTAR: showProgressMessage （展示处置消息 ）
         * @param msg
         */
