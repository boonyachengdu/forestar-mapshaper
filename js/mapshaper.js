(function () {
  ...
  */
  ...
  /**
   * FORESTAR: bufferToString （buffer数据转字符串）
   */
  ...
  /**
   * FORESTAR: decodeString （buffer解码为字符串）
   * @param {*} buf 
   * @param {*} enc 
   */
  // @buf a Node Buffer
  ...
  /**
   * FORESTAR: convertIntervalParam（转换参数）
   * @param opt
   * @param crs
   * @returns {number}
   */
  ...
  /**
   * FORESTAR: cleanPathsAfterImport（导入后清除路径）
   * @param dataset
   * @param opts
   */
  ...
  /**
   * FORESTAR: guessInputType（判定输入文件内容类型）
   * @param content
   * @returns {string}
   */
  ...
  /**
   * FORESTAR: guessInputType（判定输入文件类型）
   * @param file
   * @param content
   * @returns {string}
   */
  ...
  /**
   * FORESTAR: identifyJSONString（识别为JSON字符串）
   * @param {*} str 
   * @param {*} opts 
   */
  ...
  /**
   * FORESTAR: importGeoJSONFile（导入geoJSON文件）
   * @param {*} fileReader 
   * @param {*} opts 
   */
  ...
  */
  ...
  /**
   * FORESTAR: 输出操作日志[datasets,layers]
   */
