(function () {
  ...
  */
  ...
  function ShpReader(shpSrc, shxSrc) {
    ...
    this.nextShape = function() {
      ...
      if(shape){
        //mapshaper.js:9059 forEachShape---{"id":265,"type":5,"byteLength":2536,"partCount":1,"pointCount":155
        ...
        //console.log("shape>> id = "+shape.id+"  coordinates = "+JSON.stringify(shape.readPoints()));
      }
      return shape;
    };
  ...
  function importShp(shp, shx, opts) {
    ...
    reader.forEachShape(function(shp) {
      // console.log("forEachShape---"+JSON.stringify(shp));
      importer.startShape();
      if (shp.isNull) {
        // skip
      } else if (type == 'point') {
  ...
  */
  ...
  function makePolylineBuffer(lyr, dataset, opts) {
    console.log("makePolylineBuffer>>");
  ...
  function makeShapeBufferGeoJSON(lyr, dataset, opts) {
    console.log("makeShapeBufferGeoJSON>>");
    ...
    console.log("makeShapeBufferGeoJSON>> geometries ->"+JSON.stringify(geometries));
